...
from app.routers import video_analytics, sales_inventory, marketing, advisor, floor_plan, voice_inventory_router, ocr_inventory_router
...
app.include_router(ocr_inventory_router.router, prefix="/api")
